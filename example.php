...
echo  'run time: '.number_format(microtime(true) - $runStartTime, 4).' seconds<br/>';

echo '$encrypted ('.strlen($encrypted).' bytes) = <pre>'.base64_encode($encrypted)."</pre><br/>\n";
...
echo '$decrypted ('.strlen($decrypted).' bytes)  = <pre>'.$decrypted."</pre><br/>\n";
